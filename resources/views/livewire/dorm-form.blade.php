                    ...
                    <div class="row justify-center">
                        <div class="col-6">
                            ...
                            <div class="col-span-6 sm:col-span-4 mt-4">
                                ...
                                <select id="amphure" class="form-control text-s" name="amphure" :value="old('amphure')"
                                    required autofocus autocomplete="amphure" wire:model="amphure">
                                    <option value=""></option>
                            ...
                            <div class="col-span-6 sm:col-span-4 mt-4">
                                ...
                                <select id="district" class="form-control text-s" name="district"
                                    :value="old('district')" required autocomplete="district" wire:model="district">
                                    <option value=""></option>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" id="phone" required autofocus>
                            </div>
                            <x-jet-input-error for="phone" class="mt-2" />

                            <div class="form-group  mt-4">
                                <x-jet-label for="electricity_per_unit" value="{{ __('ค่าไฟ/หน่วย') }}" />
                                <input type="number" name="electricity_per_unit" class="form-control "
                                    id="electricity_per_unit" required autofocus>
                            </div>
