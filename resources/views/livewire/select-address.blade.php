<div>
    ...
    <div class="col-span-6 sm:col-span-4 mt-4">
        ...
        <select id="amphure" class="form-control mt-1 text-s" name="amphure" :value="old('amphure')" required autofocus
    ...
    <div class="col-span-6 sm:col-span-4 mt-4">
        ...
        <select id="district" class="form-control mt-1" name="district" :value="old('district')" required autofocus
