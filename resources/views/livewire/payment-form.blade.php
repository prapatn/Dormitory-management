{{-- Form --}}
<div class="col-md-12">
    <form action="{{route('dorm.update.payment')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="bank_name" class="form-control" id="bank_name"
                                    wire:model='bank_name' required autofocus>
                            </div>
                ...
                <div class="container mb-4 mr-2 mt-2">
                    <div class="flex items-center justify-center">
